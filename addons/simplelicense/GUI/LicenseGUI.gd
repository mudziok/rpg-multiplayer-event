...
func _ready() -> void:
	if not DirAccess.dir_exists_absolute("res://internal/resources/licenses/license_links/"):
		DirAccess.make_dir_recursive_absolute("res://internal/resources/licenses/license_links/")
...
func refresh_after_location_change():
	...
	if load_locations.size() == 0:
		load_locations.append('res://internal/resources/licenses')
